...
export const mockBrands: Brand[] = [
  {
    ...
    logo: 'https://via.placeholder.com/150/FF6B6B/FFFFFF?text=SC',
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150/4ECDC4/FFFFFF?text=UW',
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150/95E1D3/FFFFFF?text=TH',
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150/F38181/FFFFFF?text=ET',
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150/AA96DA/FFFFFF?text=LA',
...
export const mockCustomers: Customer[] = [
  {
    ...
    lastLogin: '2024-10-30T09:15:00Z',
  },
  {
    id: 'customer-2',
    ...
    lastLogin: '2024-10-29T18:30:00Z',
  },
  {
    id: 'customer-3',
    ...
    lastLogin: '2024-10-27T14:00:00Z',
  },
  {
    id: 'customer-4',
...
export const mockProducts: AdminProduct[] = [
  {
    ...
    category: 'T-Shirts',
    images: ['https://via.placeholder.com/400/FF6B6B/FFFFFF?text=T-Shirt'],
    stock: 150,
  ...
  },
  {
    ...
    brandName: 'UrbanWear',
    category: 'Jackets',
    images: ['https://via.placeholder.com/400/4ECDC4/FFFFFF?text=Jacket'],
    stock: 45,
    status: ProductStatus.ACTIVE,
    featured: true,
    sales: 128,
  ...
  },
  {
    ...
    brandName: 'TrendHub',
    category: 'Dresses',
    images: ['https://via.placeholder.com/400/95E1D3/FFFFFF?text=Dress'],
    stock: 0,
  ...
  },
  {
    ...
    images: ['https://via.placeholder.com/400/FF6B6B/FFFFFF?text=Wallet'],
    stock: 200,
    status: ProductStatus.ACTIVE,
    featured: false,
    sales: 89,
